...
class Drinking extends StatefulWidget {
  ...
  const Drinking({Key? key, this.drinking = ""}) : super(key: key);
...
class _DrinkingState extends State<Drinking> {
  ...
  void initState() {
    ...
    selectedButton = widget.drinking;
    // Pre-select the button based on the passed drinking value
    controller.selectIndex(drinkOptions.indexOf(selectedButton));
  }

  void _saveDrinking() {
    if (selectedButton.isEmpty) {
      showToast(context, 'Please select a drinking preference.');
      return;
    }
    final formData = FormData.fromMap({
      'drinking': selectedButton,
    });
