...
class Education extends StatefulWidget {
  ...
  const Education({super.key, this.education=""});

  @override
  State<Education> createState() => _ExerciseState();
}

class _ExerciseState extends State<Education> {
  ...
  void initState() {
    super.initState();
    selectedButon = widget.education;
    controller.selectIndex(education.indexOf(selectedButon)); // Pre-select the button
  }

  void _saveExercise() {
    if (selectedButon.isEmpty) {
      showToast(context, 'Please select an Education level.');
      return;
    }
    final formData = FormData.fromMap({
      'degree': selectedButon,
    });
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  CustomButton(
                    text: 'Save',
                    onPressed: _saveExercise, // Attach the method here
                  ),
                ],
              ),
            ),
