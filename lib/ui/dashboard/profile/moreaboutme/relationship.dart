...
class _SmokeingState extends State<Smokeing> {
  ...
  void _saveSmoking() {
    if (selectedButon.isEmpty) {
      showToast(context, 'Please select an Smoking level.');
      return;
    }
    final formData = FormData.fromMap({
      'relationship_status': selectedButon,
    });
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  CustomButton(
                    text: 'Save',
                    onPressed: _saveSmoking, // Attach the method here
                  ),
                ],
              ),
            ),
