...
class Pet extends StatefulWidget {
  ...
  const Pet({Key? key, this.selectedPet = ""}) : super(key: key);
...
class _PetState extends State<Pet> {
  ...
  void initState() {
    ...
    selectedButton = widget.selectedPet;
    // Pre-select the button based on the passed pet value
    controller.selectIndex(pets.indexOf(selectedButton));
  }

  void _savePet() {
    if (selectedButton.isEmpty) {
      showToast(context, 'Please select a pet.');
      return;
    }
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  CustomButton(
                    text: 'Save',
                    onPressed: _savePet, // Attach the method here
                  ),
                ],
              ),
            ),
