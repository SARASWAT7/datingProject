...
class Religion extends StatefulWidget {
  ...
  const Religion({Key? key, this.religion = ""}) : super(key: key);
...
class _ReligionState extends State<Religion> {
  ...
  void initState() {
    ...
    selectedButton = widget.religion;
    // Pre-select the button based on the passed religion value
    controller.selectIndex(religions.indexOf(selectedButton));
  }

  void _saveReligion() {
    if (selectedButton.isEmpty) {
      showToast(context, 'Please select a religion.');
      return;
    }
    final formData = FormData.fromMap({
      'religion': selectedButton,
    });
