...
class LisenseUsed extends StatefulWidget {
  const LisenseUsed({super.key});

  @override
  State<LisenseUsed> createState() => _LisenseUsedState();
}

class _LisenseUsedState extends State<LisenseUsed> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: AppText(
            size: 16.sp, text: 'License Used', fontWeight: FontWeight.w600),
      ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          // HeightBox(1.h),
                          Html(
                            data: state.response?.result?[1].description ?? '',
                            style: {
                              'p': Style(
                                color: blackColor,
                              ),
