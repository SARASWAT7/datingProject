...
class FilterDoTheyDrink extends StatefulWidget {
  const FilterDoTheyDrink({Key? key}) : super(key: key);

  @override
  State<FilterDoTheyDrink> createState() => _FilterDoTheyDrinkState();
}

class _FilterDoTheyDrinkState extends State<FilterDoTheyDrink> {
                ...
                children: [
                  Padding(
                    ...
                    child: CustomText(
                      ...
                      size: 18,
                      text:
                          'Select the alcohol consumption level of your loved one as per your preference.',
                      color: Colors.black,
                  ...
                  GestureDetector(
                    onTap: () {
                      context.read<FilterCubit>().doDrinkUpdate(selectedButton);
