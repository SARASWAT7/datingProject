...
import 'package:demoproject/component/reuseable_widgets/text_field.dart'; // Ensure correct import

class FilterPets extends StatefulWidget {
  const FilterPets({Key? key}) : super(key: key);

  @override
  State<FilterPets> createState() => _FlutterPetsState();
}

class _FlutterPetsState extends State<FilterPets> {
  List<String> name = [
    "Pet-Free",
    "Don’t Have",
    "But Love",
              ...
              child: Column(
                children: [
                  AppText(
                    size: 18,
                    maxlin: 2,
                    text: 'Select the pets you would prefer in your partner.',
                    color: Colors.black,
                  ...
                  GestureDetector(
                    onTap: () {
                      context.read<FilterCubit>().petsUpdate(selectedPets);
                      Navigator.pop(context); // Return selected pets
                    },
