...
class FlutterSunShine extends StatefulWidget {
  const FlutterSunShine({Key? key}) : super(key: key);

  @override
  State<FlutterSunShine> createState() => _FlutterSunShineState();
}

class _FlutterSunShineState extends State<FlutterSunShine> {
                ...
                children: [
                  Padding(
                    ...
                    child: AppText(
                      ...
                      maxlin: 2,
                      text:
                          'Select the sun sign you would prefer in your partner.',
                      color: Colors.black,
                  ...
                  GestureDetector(
                    onTap: () {
                      context.read<FilterCubit>().sunSignUpdate(selectedButon);
