...
import 'flutterwantkids.dart';

class FilterEducation extends StatefulWidget {
  const FilterEducation({Key? key}) : super(key: key);

  @override
  State<FilterEducation> createState() => _FlutterEducationState();
}

class _FlutterEducationState extends State<FilterEducation> {
                ...
                child: Column(
                  children: [
                    AppText(
                      ...
                      maxlin: 2,
                      text:
                          'Select the education level of the love one as per your Preference.',
                      color: Colors.black,
