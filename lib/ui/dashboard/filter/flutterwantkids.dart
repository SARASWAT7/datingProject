...
class FlutterWantKids extends StatefulWidget {
  const FlutterWantKids({Key? key}) : super(key: key);

  @override
  State<FlutterWantKids> createState() => _FlutterWantKidsState();
}

class _FlutterWantKidsState extends State<FlutterWantKids> {
              ...
              child: Column(
                children: [
                  ...
                  AppText(
                    ...
                    maxlin: 2,
                    text:
                        'Select want for child you would prefer in your partner.',
                    color: Colors.black,
                  ...
                  GestureDetector(
                    onTap: () {
                      context.read<FilterCubit>().kidsUpdate(selectedButon);
