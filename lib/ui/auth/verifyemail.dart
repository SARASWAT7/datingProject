...
class VerifyEmailScreen extends StatefulWidget {
  ...
  const VerifyEmailScreen({super.key, required this.code,
    this.phoneNUmber='' ,
    this.Email="",
                      ...
                      Center(
                          child: GestureDetector(
                              onTap: () {
                                context
                                    .read<VerifyOtpWithPhoneCubit>()
                                    .resendEmail(context,widget.code,widget.Email,widget.longitute,widget.latitude,widget.deviceType,widget.deviceToken);
                              },
